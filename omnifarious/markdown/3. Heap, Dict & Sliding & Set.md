...
class Solution(object):
    def topKFrequent(self, words, k):
        ...
        for key, value in list(dic.items())[:k]:
            heapq.heappush(heap, (value, convert(key)))
        ...
        for value, tupl in heap[::-1]:
            res.append(restore(tupl))
...
class Solution:
    def topKFrequent(self, words: List[str], k: int) -> List[str]:
        ...
        while heap:
            ...
            res.appendleft((value, key))
        
        # for value, key in heap[::-1]:
        #     res.append(key)
        ...
        while i >= 0:
            if res[i][0] != res[i-1][0]:
                ...
                print('yes')
                j = i - 1
                while j >= 0 and res[j][0] == res[i][0]:
                    j -= 1
                
                print(j, i)
                res[j+1:i+1] = res[j+1:i+1][::-1]
...
```
    ...
    <ipython-input-101-815205c8ca3a> in <module>
    ----> 1 ord('hello')
...
## 609. Find Duplicate File in System (Facebook 4, Google 2, Apple 2)
    ...
    def findDuplicate(self, paths):
        ...
        for line in paths:
            ...
            for word in array[1:]:
                ...
                dic[word[i+1:len(word)-1]].append(array[0] + '/' + word[:i]) 
        # print(dic)
...
## Find the Difference (Google 2, Amazon 2)
...
## Single Number II (Facebook 4, Google 3, Amazon 2)
